...
function displaySearchResults(results) {
	...
	const startNum = (global.search.page - 1) * 20 + 1;
	let endNum;
	if (global.search.page === global.search.totalPages) {
		endNum = global.search.totalResults;
	} else {
		endNum = global.search.page * 20;
	}
	...
	results.forEach((result) => {
		...
		document.querySelector('#search-results-heading').innerHTML = `
		<h2>${startNum} - ${endNum} of ${global.search.totalResults} Results for ${global.search.term}</h2>`;
